<?php
	...
	class EditarController{
		...
		private function EditarVeiculo($vei){
			$vDao = new VeiculoDAO();
			$vDao->updateVeiculo($vei, $_POST['id']);
			$this->msg = "Veiculo Editado com Sucesso!";
			$this->showMessage();
		}
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		$register = new EditarController($_POST);
	}
?>